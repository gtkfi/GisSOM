...
Function to edit data columns saved as numpy arrays saved in binary format. Actual data begins around index 5 or 6, the first entries
...
if(len(sys.argv)>7): 
    ...
    #print(column[0:8]) #print coltype isWinsorized WinMin WinMax IsLogTransformed etc, this is read in VM
